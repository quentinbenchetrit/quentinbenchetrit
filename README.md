...
**[vol-surface-engine](https://github.com/quentinbenchetrit/vol-surface-engine)**: an arbitrage-free implied volatility surface and stochastic-volatility pricing engine on live Deribit option data. The arbitrage-free SVI and SSVI surfaces and a Heston model calibrated to the live surface are in; I am now adding Dupire local vol and Monte Carlo pricing of exotics.
